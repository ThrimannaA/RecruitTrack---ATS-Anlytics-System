...
text
The candidate shows strong alignment with the Data Scientist role. 
Key strengths include Python, Machine Learning, and SQL expertise. 
However, experience with cloud platforms (AWS/GCP) is limited compared to requirements.
Missing Keywords Example
text
Critical missing keywords for ATS ranking:
- TensorFlow (required for ML models)
- Docker (containerization experience needed)
...
- Data analysis (Good match)
- SQL databases (Partial match)
...
Visual charts for skill matching
